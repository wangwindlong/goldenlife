...
// */
//
//package net.wangyl.goldenlife.ui.groupie
//
...
//    private val viewModel: BaseListVM<Model>
//) :
//    BindableItem<Binding>() {
//
//    lateinit var binding :Binding
//    override fun initializeViewBinding(view: View) = binding.inflate(LayoutInflater.from(context))
//
//    override fun isSameAs(other: com.xwray.groupie.Item<*>) =
//        other is BaseListItem<*,*> && model == other.model
//
