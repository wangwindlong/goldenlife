...
class StickyNavigator (
    private val context: Context,
    private val fragmentManager: FragmentManager,
    private val containerId: Int
) : Navigator<StickyNavigator.Destination>() {
...
//        ft.setPrimaryNavigationFragment(frag)
    ...
    public constructor(fragmentNavigator: Navigator<out Destination>) : NavDestination(fragmentNavigator) {
        ...
        public constructor(navigatorProvider: NavigatorProvider) :
                this(navigatorProvider.getNavigator(StickyNavigator::class.java))

        @CallSuper
        public override fun onInflate(context: Context, attrs: AttributeSet) {
            super.onInflate(context, attrs)
            context.resources.obtainAttributes(attrs, R.styleable.StickyNavigator).use { array ->
                val className = array.getString(R.styleable.StickyNavigator_android_name)
    ...
    private companion object {
        private const val TAG = "StickyNavigator"
