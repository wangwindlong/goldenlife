package net.wangyl.goldenlife.ui.nav
...
public class StickyDialogNavigator(
    private val context: Context,
    private val fragmentManager: FragmentManager
) : Navigator<StickyDialogNavigator.Destination>() {
        ...
        if (event == Lifecycle.Event.ON_CREATE) {
            ...
            if (!dialogFragment.requireDialog().isShowing) {
                ...
                if (beforePopList.lastOrNull() != poppedEntry) {
                    Log.i(TAG, "Dialog $dialogFragment was dismissed while it was not the top " +
    ...
    public constructor(fragmentNavigator: Navigator<out Destination>) :
        ...
        public constructor(navigatorProvider: NavigatorProvider) : this(
            navigatorProvider.getNavigator(StickyDialogNavigator::class.java)
        )
        ...
        public override fun onInflate(context: Context, attrs: AttributeSet) {
            ...
            context.resources.obtainAttributes(
                attrs,
                R.styleable.StickyDialogFragmentNavigator
            ).use { array ->
                val className = array.getString(R.styleable.StickyDialogFragmentNavigator_android_name)
    ...
    private companion object {
        private const val TAG = "StickyDialogNavigator"
    }
}