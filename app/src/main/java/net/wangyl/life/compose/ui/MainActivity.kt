        ...
        setContent {
            MyComposeTheme(Global.theme) {
                ...
                systemUiController.setNavigationBarColor(
                    color = MyComposeTheme.colors.bottomBar.convert(ColorSpaces.Acescg)
                )
                MainScreen()
//                TextButton(onClick = {}) {
//
...
private fun HomeNavigationItemIcon(item: HomeNavigationItem, selected: Boolean) {
    val tint = if (selected) MyComposeTheme.colors.iconSelected else MyComposeTheme.colors.icon
...
internal fun HomeBottomNavigation(
    ...
    BottomNavigation(
        backgroundColor = MyComposeTheme.colors.bottomBar.copy(alpha = 1f),
//        contentColor = contentColorFor(MyComposeTheme.colors.iconSelected),
        ...
        HomeNavigationItems.forEach { item ->
            BottomNavigationItem(
                ...
                selectedContentColor = MyComposeTheme.colors.iconSelected,
                unselectedContentColor = MyComposeTheme.colors.icon,
