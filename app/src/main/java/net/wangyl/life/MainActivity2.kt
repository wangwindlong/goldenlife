...
import net.wangyl.life.databinding.ActivityMainBinding
...
//        navController.setGraph(R.navigation.mobile_navigation)
        ...
        binding.navView?.let {
            it.getHeaderView(0).findViewById<ImageView>(R.id.imageView).background = AppCompatResources.getDrawable(this, R.mipmap.ic_launcher)
