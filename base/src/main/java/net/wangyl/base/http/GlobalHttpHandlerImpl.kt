...
import net.wangyl.base.http.log.RequestInterceptor
...
//            try {
//                val list: List<User> = ArmsUtils.obtainAppComponentFromContext(context).gson().fromJson(httpResult, object : TypeToken<List<User?>?>() {}.getType())
//                val user: User = list[0]
//                Timber.w("Result ------> " + user.getLogin().toString() + "    ||   Avatar_url------> " + user.getAvatarUrl())
//            } catch (e: Exception) {
//                e.printStackTrace()
//                return response
//            }
