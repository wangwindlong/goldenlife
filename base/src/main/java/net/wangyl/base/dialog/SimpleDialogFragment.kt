...
class SimpleDialogFragment : CoroutineDialogFragment<Unit>() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog =
        AlertDialog.Builder(requireContext())
            ...
            .setMessage(message)
            .apply {
                this@SimpleDialogFragment.isCancelable = isDialogCancelable
    ...
    companion object {
        ...
        ): SimpleDialogFragment = SimpleDialogFragment().apply {
            arguments = bundleOf(
                ARGS_TITLE to title,
